...
_______________________________________
func subtractSum(_ n: Int) -> String {
    let fruit = [1: "kiwi", 2: "pear", 3: "kiwi", 4: "banana", 5: "melon", 6: "banana", 7: "melon", 8: "pineapple", 9: "apple",
                 ...
                 90: "apple", 91: "kiwi", 92: "banana", 93: "kiwi", 94: "banana", 95: "melon", 96: "banana", 97: "melon", 98: "pineapple", 99: "apple",
                 100: "pineapple"]
    
    guard 10..<10000 ~= n else {
        return fruit[n]!
    }
    let string = String(n)
    let array = Array(string)
    let sum = array.compactMap { Int(String($0)) }.reduce(0, +)
    guard 1...100 ~= n - sum else {
